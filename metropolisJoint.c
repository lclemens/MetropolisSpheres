...
//    }
    ...
    // TCR configuration estimated from PDB: 6JXR
        ...
        rAnchor[1][0] = -cos( 0.753 )*4.1;
        rAnchor[1][1] = sin( 0.753 )*4.1;
        rAnchor[1][2] = 0;
        ...
        rAnchor[3][0] = -cos( 0.5095 )*8.0667;
        rAnchor[3][1] = sin( 0.5095 )*8.0667;
        rAnchor[3][2] = 0;
    
        rAnchor[4][0] = -cos( 0.97545 )*10.1667;
        rAnchor[4][1] = sin( 0.97545 )*10.1667;
        rAnchor[4][2] = 0;
    
        rAnchor[5][0] = -cos( 1.069 )*11.3;
        rAnchor[5][1] = sin( 1.069 )*11.3;
        rAnchor[5][2] = 0;
    ...
    for(i=3;i<5;i++)
    {
        ...
        rSphere[i][2] = 2*sRadius*(i-1)+i*0.0001;
    }
    ...
    for(i=6;i<8;i++)
    {
        rSphere[i][0] = rAnchor[3][0];
        rSphere[i][1] = rAnchor[3][1];
        rSphere[i][2] = 2*sRadius*(i-4)+i*0.0001;
    }
    ...
    for(i=3;i<5;i++)
    {
        ...
        rSphere[i+10][2] = 2*sRadius*(i-1)+i*0.0001;
    }
    // sphere 5 attached to anchor 3
    for(i=5;i<6;i++)
    {
    ...
    for(i=6;i<8;i++)
    {
        rSphere[i+10][0] = rAnchor[3][0];
        rSphere[i+10][1] = rAnchor[3][1]-sRadius;
        rSphere[i+10][2] = 2*sRadius*(i-4)+i*0.0001;
    }
    // spheres 8, 9 attached to anchors 4, 5
    for(i=8;i<10;i++)
    {
    ...
    //debugging: print initial condition
